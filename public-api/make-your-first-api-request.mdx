...
description: "Send a read-only GET request to the Compute API to verify your API key, base URL, and JSON response handling before making state-changing calls."
