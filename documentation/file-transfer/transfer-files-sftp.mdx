...
description: "Move files to and from a Compute with Hivenet instance over SFTP using the sftp CLI, WinSCP, or FileZilla, with example commands and connection settings."
