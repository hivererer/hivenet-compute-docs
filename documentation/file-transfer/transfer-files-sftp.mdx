...
description: "Move data to and from a Compute instance using SFTP with the CLI, WinSCP, or FileZilla, including host, port, and SSH key setup for secure transfers."
