...
<Tip>
  _All methods use the same SSH key you already uploaded for Compute._
</Tip>
...
| `lcd <local-path>` | **Change _local_ working folder**Use quotes if the path has spaces. | `lcd "C:\Users\You\Downloads"` | `lcd ~/Downloads`     |
...
Still stuck? Ping us via the chat widget or join [Discord](https://discord.gg/cTmPDPrMG2).