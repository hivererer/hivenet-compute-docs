...
description: "Use the endpoint URL, model identifier, and Inference API key from your endpoint to send OpenAI-compatible Chat Completions requests with Python, JavaScript, or curl."
icon: "terminal"
---
