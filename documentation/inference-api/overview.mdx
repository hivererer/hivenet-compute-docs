...
description: "Learn how Hivenet Inference API serves open-weight models as managed, OpenAI-compatible endpoints with fixed replicas and shared Compute billing."
icon: "sparkles"
---
