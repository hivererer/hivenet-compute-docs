...
description: "Deploy a managed model endpoint, create an Inference API key, and send your first OpenAI-compatible Chat Completions request from the Hivenet Compute console."
icon: "rocket"
---
