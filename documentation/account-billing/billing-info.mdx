...
2. Choose an amount (e.g., **€20**, **€50**, **€100**, **€500**).
   - You’ll see the current first-purchase bonus (for example, “Get +€10/€40/€125/€250 for free”). This is applied **once per account** and may vary by offer.
...
> **Heads-up:** **Billing details** and **Transaction history** are labeled _Coming soon_ in the Billing page. Until then, use Stripe receipts for your records. If you need a consolidated statement, contact Support.
