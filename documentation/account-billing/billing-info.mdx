...
description: "Understand how Compute with Hivenet prepaid credits, per-second charges, add funds, and auto top-up work so you can budget instance usage."
...
- **Low/zero balance:** Instances won’t start without enough credit. If your balance gets too low while an instance is running, Compute may terminate it to prevent negative charges (usually with a short pre-emptive window). Add credits and start again.
