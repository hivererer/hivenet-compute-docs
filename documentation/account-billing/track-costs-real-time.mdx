...
description: "Use the Compute overview, Billing page, and instance list to monitor your organization’s credit balance, spend rate, and per-instance active costs."
...
- **Stop** it if you expect to continue later and want to preserve its environment temporarily.
- **Terminate** it when the work is finished and you no longer need its local data.

<Warning>
  Termination permanently deletes the instance and its local data. Save anything important first.
</Warning>

For the full lifecycle explanation, see [How to stop or terminate a Compute instance](/documentation/essentials/stop-terminate-instance).
