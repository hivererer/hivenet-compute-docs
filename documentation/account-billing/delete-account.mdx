...
description: "Permanently delete your Compute with Hivenet account, including all instances, disks, snapshots, backups, and remaining credits, and know what happens next."
