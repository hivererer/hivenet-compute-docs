...
description: "Permanently remove your Compute account, terminate active instances, and delete all associated data, SSH keys, and billing information from Hivenet."
