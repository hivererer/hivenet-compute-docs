...
If you just need a breather, you can [pause or shut down instances instead](https://help.hivenet.com/en/articles/314603-how-to-stop-or-delete-a-compute-instance-on-hivenet). Feel free to [contact Support](mailto:support@hivenet.com) to explore alternatives.
...
1. Sign in to Hivenet and select **Account → Settings**.
...
- Any pending deployment or billing processes tied to Compute are cancelled.
...
Still have questions? Join us on [Discord](https://discord.gg/cTmPDPrMG2) or chat with the team on the site.