...
description: "Step-by-step guide to create your Hivenet account, launch your first GPU or CPU Compute instance, and connect over SSH from your local machine."
icon: "code"
