---
title: "Using vCPUs"
description: "Learn how vCPUs work on Compute with Hivenet, when to pick a CPU-only instance over a GPU, and which vCPU, RAM, and disk sizes are available."
icon: "recycle"
...
- [Using GPUs in Compute with Hivenet](/documentation/essentials/create-instance)