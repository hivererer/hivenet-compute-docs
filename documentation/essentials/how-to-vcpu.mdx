---
title: "Using vCPU instances on Compute with Hivenet"
description: "How vCPUs work on Compute with Hivenet, when to choose a CPU-only instance over a GPU, available sizes, and how to launch a vCPU workload."
icon: "recycle"
