---
title: "Deploy a vLLM inference server on Compute"
description: "How vLLM powers inference servers on Compute with Hivenet: deploy a model, review default settings, and tune optional parameters for your workload."
icon: "map"
