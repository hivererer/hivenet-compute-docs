...
description: "Deploy a vLLM inference server on Compute with Hivenet, including default settings, supported models, and optional configuration flags you can override."
icon: "map"
