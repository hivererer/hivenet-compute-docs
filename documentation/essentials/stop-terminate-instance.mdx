---
title: "Stop or terminate a Compute instance on Hivenet"
description: "Understand the difference between Stop and Terminate on Compute with Hivenet, how each affects data and billing, and how to pick the safest action."
...
| **Terminate** | Deletes the instance permanently | No                        | No            | Yes           | Yes, immediately      |
