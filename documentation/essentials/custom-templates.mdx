...
description: "Create, save, and reuse custom Compute with Hivenet templates so you can launch instances with your own container image, ports, and environment settings."
icon: "text-size"
