...
description: "Create, edit, and reuse custom container templates on Compute with Hivenet to launch instances with the same image, ports, and settings every time."
icon: "text-size"
