...
description: "A practical guide to picking, launching, and connecting to the right Compute instance on Hivenet based on GPU, vCPU, RAM, disk, and workload needs."
icon: "chart-tree-map"
