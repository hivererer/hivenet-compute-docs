...
description: "Reference for CPU-only Compute with Hivenet instances on AMD EPYC 7713 hosts, with fixed vCPU, RAM, disk, and bandwidth options for each size."
...
- You can [**start/stop instances**](/documentation/essentials/start-stop-instances) without extra fees