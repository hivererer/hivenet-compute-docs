---
title: "Glossary"
description: "Alphabetical glossary of terms used across the Hivenet Compute docs: instances, GPUs, vCPUs, vLLM, SSH, credits, and other core concepts explained."
...
**GPU instance** — A container or a virtual machine with a dedicated GPU for your workload.
...
**instance** — A running container or virtual machine on Compute. Billed while running; can be stopped or terminated.
