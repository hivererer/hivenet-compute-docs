...
<Warning>
  **Important:** Stopped instances are not kept indefinitely.\
  If an instance remains stopped for more than 5 days, it is automatically terminated. Once terminated, the instance and its data cannot be recovered.
</Warning>
