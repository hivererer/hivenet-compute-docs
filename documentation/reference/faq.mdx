...
sidebarTitle: "FAQ"
description: "Answers to common questions about Compute with Hivenet, including instances, GPU and CPU types, billing, credits, SSH access, and usage limits."
---
...
Yes. You can [**stop an instance and start it again**](/articles/essentials/start-stop-instances) without losing your environment. Your files, packages, and configuration remain intact. Stopping releases the underlying capacity back to the pool. When you start again, availability depends on demand, and you may be placed on different hardware.
