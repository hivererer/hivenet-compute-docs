...
description: "Reference list of language models available in the Compute with Hivenet vLLM inference template, with parameter sizes and upcoming additions."
...
> Host hardware: AMD EPYC 7713; GPU sizes listed in [**GPU types and sizes.**](/documentation/reference/gpu-types)