...
description: "Troubleshoot Bad Gateway errors on Compute with Hivenet instance URLs, including common causes tied to instance status, ports, and app startup."
