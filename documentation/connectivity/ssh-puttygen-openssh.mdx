---
title: "SSH into a Compute instance from Windows"
description: "Convert a PuTTYgen private key to OpenSSH format and connect to your Compute instance from Windows using the built-in ssh command."
