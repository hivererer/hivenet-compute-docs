---
title: "SSH into a Compute instance on Windows with PuTTY"
description: "Convert a PuTTYgen private key to OpenSSH format and connect from Windows to a Compute instance using PuTTY or the built-in ssh client."
