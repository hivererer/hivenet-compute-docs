---
title: "Agent network and firewall basics"
description: "Learn what the Hivenet Agent does, which ports and hosts it needs, and how to configure your firewall to avoid Compute connection and login issues."
...
Most users don’t need to manually open ports unless:
...
- You want to ensure the best-case network performance with external tools
...
| Where you are running         | What to do                                             |
| :---------------------------- | :----------------------------------------------------- |
