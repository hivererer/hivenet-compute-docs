...
description: "How the Hivenet Agent uses your network, which ports and hosts it needs, and how to configure firewalls and proxies to avoid connection issues."
