...
description: "Generate an SSH key on Windows using PowerShell or PuTTYgen and add the public key to Compute with Hivenet to connect to instances securely."
