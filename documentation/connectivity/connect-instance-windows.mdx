...
description: "Connect to a Compute instance from Windows using PowerShell, OpenSSH, or PuTTY, from your first SSH login through reaching a working shell prompt."
