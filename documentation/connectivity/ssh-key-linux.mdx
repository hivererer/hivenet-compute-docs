...
description: "Generate an ed25519 SSH key on Linux with ssh-keygen and add the public key to Compute with Hivenet so you can connect to instances securely."
