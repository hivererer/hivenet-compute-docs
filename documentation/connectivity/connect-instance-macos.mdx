...
description: "Connect to a Compute instance from macOS using the built-in Terminal and SSH: find your instance details, run the ssh command, and log in securely."
