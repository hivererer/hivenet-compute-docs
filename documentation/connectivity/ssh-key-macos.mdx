...
description: "Generate an SSH keypair with ssh-keygen on macOS, add the public key to your Hivenet account, and connect to your first Compute instance from Terminal."
