---
title: "Serve a simple HTTPS site with SSH port forwarding"
description: "Run python -m http.server or your own web app on Compute and reach it securely from your browser using SSH port forwarding and local HTTPS."
