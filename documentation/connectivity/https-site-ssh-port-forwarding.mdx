---
title: "Serve an HTTPS site with SSH port forwarding"
description: "Run python -m http.server or your own web app on a Compute instance and reach it locally over an encrypted SSH tunnel, without public exposure."
