...
description: "An introduction to Hivenet and Compute: what the distributed cloud is, why it exists, and how it changes the way you run GPU and CPU workloads."
...
2. [Pick a template or OS](/articles/essentials/custom-templates) (ready images or your custom template) and choose hardware (e.g., RTX 4090/5090 GPUs, AMD EPYC CPUs).
3. Launch your instance and connect over SSH or via your chosen stack (e.g., vLLM).

Pause work with [**stop/start**](/articles/essentials/start-stop-instances) or [**terminate**](/articles/essentials/stop-terminate-instance) when finished. You only pay for what runs.
