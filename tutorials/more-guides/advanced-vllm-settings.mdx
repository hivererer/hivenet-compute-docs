...
description: "Advanced vLLM configuration reference for Compute with Hivenet, including tensor parallelism, GPU memory utilization, quantization, and sampling parameters."
sidebarTitle: "Advanced vLLM settings"
---
...
- [How vLLMs work](/documentation/essentials/how-to-vllm)