---
title: "SSH config, known_hosts, and identity files explained"
description: "Understand what lives in your .ssh folder: the config file, known_hosts, identity keys, and how each shapes SSH connections to Compute instances."
