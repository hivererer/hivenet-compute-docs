---
title: "The SSH config file, known_hosts, and identity files"
description: "Understand what lives inside your .ssh folder, how known_hosts and identity files work, and how the SSH config file simplifies connecting to Compute instances."
