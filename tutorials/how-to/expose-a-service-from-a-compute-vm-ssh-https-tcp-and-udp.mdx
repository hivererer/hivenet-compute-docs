...
description: "Compare the four connectivity options for Compute virtual machines—SSH, HTTPS, TCP, and UDP—and choose the right one for exposing your service."
