...
description: "Launch a Compute instance with the Jupyter template and open a browser-based notebook with GPU access. No SSH or command line required to get started."
