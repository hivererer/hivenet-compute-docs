...
description: "Launch a Compute with Hivenet instance and open a Jupyter notebook in your browser using the built-in template, without SSH or command-line setup."
