...
description: "Deploy the EVO2 40B genomic model on Compute with Hivenet using Nvidia NIM containers, including instance sizing, GPU setup, and inference testing."
