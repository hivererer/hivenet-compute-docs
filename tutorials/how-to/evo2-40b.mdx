...
description: "Deploy the EVO2 40B genomic language model on Compute with Hivenet using Nvidia NIM containers, from picking a GPU instance to running your first request."
...
<Steps>
  <Step title="Create the custom NIM template" titleSize="h3">
