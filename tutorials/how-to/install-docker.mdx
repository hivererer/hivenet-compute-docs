...
description: "Launch a Compute virtual machine, connect over SSH, install Docker Engine on Ubuntu, Debian, or Fedora, and verify the daemon runs a hello-world container."
---
