...
description: "Launch a Compute virtual machine on Hivenet, connect over SSH, install Docker Engine on Ubuntu, Debian, or Fedora, and verify the setup with hello-world."
---
