---
title: "Compute setup for image-generation tools"
description: "Pick the right Compute GPU, vCPU, RAM, and disk size for Stable Diffusion, ComfyUI, and other image-generation tools to get the best results."
